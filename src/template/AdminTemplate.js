...
import { faAngleDown, faBowlFood, faBottleWater, faGamepad, faShop, faList, faFaceFrown, faFaceDizzy, faFaceFrownOpen, faBaby, faUser, faPerson, faStaffAesculapius, faListCheck, faListDots, faLineChart } from '@fortawesome/free-solid-svg-icons'
                                    ...
                                    <div className="widget-content p-0">
                                        <div className="widget-content-wrapper">
                                            <div className="widget-content-left">
                                                <div className="btn-group">
                                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" className="p-0 btn">
                                                        <img width={42} className="rounded-circle" src="https://e7.pngegg.com/pngimages/84/165/png-clipart-united-states-avatar-organization-information-user-avatar-service-computer-wallpaper-thumbnail.png" alt />
                                                        <i className="metismenu-state-icon pe-7s-angle-down caret-left " style={{ fontSize: '10px' }} />
                                                    </a>
                                            ...
                                            <div className="widget-content-left  ml-3 header-user-info">
                                                <div className="widget-heading" style={{ marginTop: '5px', fontSize: '20px' }}>
                                                    {localStorage.getItem('username') === "admin" ? <div>Admin</div> : <div>{localStorage.getItem('username')}</div>}
                                                </div>
                                                <div className="widget-subheading" style={{ display: 'flex' }}>
                                                    <p style={{ paddingRight: '5px' }}>Vai Trò : </p>
                                                    <p>{localStorage.getItem('username') === "admin" ? <div>Quản Trị</div> : <div>Nhân Viên</div>}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <li>
                                                    <NavLink to='/admin' style={{ textDecoration: 'none' }}>
                                                        <FontAwesomeIcon icon={faPerson} style={{ position: 'absolute', left: '10px', top: '11px' }} />
                                                        Quản Lý Nhân viên
                                                    </NavLink>
                                                </li>
                                            </div>
