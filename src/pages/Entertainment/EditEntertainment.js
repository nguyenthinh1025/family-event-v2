...
import { GetEntertainmentByActionAction, UpdateEntertainmenAction } from '../../redux/action/EntertainmentAction';
export default function EditEntertainment (props) {
    ...
    const formik = useFormik({
        initialValues: {
            entertainmentId: arrEntertainmentById.entertainmentId,
            status: true,
            entertainmentTotal: arrEntertainmentById.entertainmentTotal
        },
        ...
        <div classname="app-main__inner  pt-2" style={{ width: '100%', margin: '0 auto', paddingTop: '50px', paddingBottom: '50px' }}>
            <div className=' pl-5 pb-5'>
                <div className='d-flex justify-content-between'>
                    <div className='d-flex justify-content-between align-items-center' style={{ fontSize: '25px' }}><NavLink to='/entertainment' style={{ textDecoration: 'none', paddingRight: '10px' }}>Giả Trí</NavLink> / <span style={{ paddingTop: '2px', fontSize: '25px', paddingLeft: '10px', paddingRight: '10px' }}>Chỉnh sửa </span></div>
