...
import { AddEventTypeAction, GetListEventTypeByIdAction, UpdateEventTypeAction } from '../../redux/action/EventTypeAction';
export default function AddEventType (props) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (value) => {
            console.log(value);
            const action = await AddEventTypeAction(value);
            await dispatch(action)
            toast(`Thêm mới ${formik.values.eventTypeName} thành công`, {
                ...
                <form className="form-horizontal" onSubmit={formik.handleSubmit}>
                    <div className='row'>
                        <div className="form-group col">
                            ...
                            <div className="col-xs-9">
                                <input name="eventTypeName" className="form-control" id="inputEmail" onChange={formik.handleChange} />
                    ...
                    <div className="form-group">
                        ...
                        <div style={{ marginBottom: '30px' }}>
                            {formik.values.eventTypeImage === "" ? <div></div> : <img src={formik.values.eventTypeImage} width={300} height={300} />}
                        </div>
