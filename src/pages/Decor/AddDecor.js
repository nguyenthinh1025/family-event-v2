...
export default function AddDecor (props) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (value) => {
            console.log(value);
            const action = await AddDecorAction(value);
            await dispatch(action)
            toast(`Thêm mới ${formik.values.decorationName} thành công`, {
        ...
        <div classname="app-main__inner  pt-2" style={{ width: '100%', margin: '0 auto', paddingTop: '50px', paddingBottom: '50px' }}>
            <div className='container pl-5 pb-5'>
                <div className=' d-flex justify-content-between'>
                    <div className='d-flex' style={{ fontSize: '25px' }}><NavLink to='/decor' style={{ paddingRight: '10px' }}>Trang Trí</NavLink> / <span style={{ paddingLeft: '10px', paddingTop: '5px', fontSize: '25px' }}>Thêm mới trang trí</span> </div>
                ...
                <form className="form-horizontal" onSubmit={formik.handleSubmit}>
                    <div className='row'>
                        <div className="form-group col">
                            ...
                            <div className="col-xs-9">
                                <input name="decorationName" className="form-control" id="inputEmail" onChange={formik.handleChange} />
                        ...
                        <div className="form-group col">
                            ...
                            <div className="col-xs-9">
                                <input type="number" className="form-control" id="inputPassword" name="decorationPrice" onChange={formik.handleChange} />
                    ...
                    <div className="form-group">
                        ...
                        <div style={{ marginBottom: '30px' }}>
                            {formik.values.decorationImage === '' ? <div></div> : <div><img src={formik.values.decorationImage} width={300} height={200} /></div>}
                        </div>
